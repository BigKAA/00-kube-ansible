...
- [x] Обновить `README.md`: добавить секцию про external etcd
- [x] Обновить `AGENTS.md`: добавить информацию о external etcd, новой роли, переменных
- [x] Добавить пример инвентори с etcd нодами
- [x] Добавить информацию о матрице совместимости k8s ↔ etcd версий

## 10. TODO (будущие задачи)

- [x] Поддержка внешнего CA (предоставление готовых сертификатов) — задокументировано в TODO
- [x] Миграция со stacked etcd на external etcd — задокументировано в TODO
- [x] Backup/restore etcd (snapshot) — задокументировано в TODO
- [x] etcdctl wrapper как Ansible-задача — задокументировано в TODO
- [x] Добавление/удаление etcd members через Ansible — задокументировано в TODO
- [x] Замена отказавшей etcd ноды — задокументировано в TODO

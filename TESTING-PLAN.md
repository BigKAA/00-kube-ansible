...
> **ВАЖНО:** В `hosts-homelab.yaml` обнаружена ошибка — дубликат `r4.kryukov.lan` (строки 13-16).
> Вторая запись с IP 192.168.218.135 должна быть `r5.kryukov.lan`.
> **Необходимо исправить перед началом тестирования.**
